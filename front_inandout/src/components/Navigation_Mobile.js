        ...
        role === "ROLE_ADMIN" ?
            ...
            <Sider width={200} className="site-layout-background2">
                ...
                >
                    ...
                    <SubMenu key="sub2" icon={<UserOutlined />} title="내" >
                        <Menu.Item key="5"><Link to="/mypage">프</Link></Menu.Item>
                    </SubMenu>
                    <SubMenu key="sub3" icon={<LaptopOutlined />} title="내">
                        <Menu.Item key="6"><Drawer /></Menu.Item>
                        <Menu.Item key="7"><Link to="/work">근</Link></Menu.Item>
                    </SubMenu>
                    <SubMenu key="sub4" icon={<FileSearchOutlined />} title="의">
                        <Menu.Item key="8"><Link to="/him">의</Link></Menu.Item>
                        <Menu.Item key="9"><Link to="/wtm">근</Link></Menu.Item>
                    </SubMenu>
                    <SubMenu key="sub5" icon={<IdcardOutlined />} title="사">
                        <Menu.Item key="10"><Link to="/addEmployee">사</Link></Menu.Item>
                        <Menu.Item key="11"><Link to="/employeeManagement">사</Link></Menu.Item>
                        <Menu.Item key="12"><Link to="/leaveManagement">휴</Link></Menu.Item>
                    </SubMenu>
                    <SubMenu key="sub6" icon={<NotificationOutlined />} title="공">
                        <Menu.Item key="13"><Link to="/addNotice">공</Link></Menu.Item>
                        <Menu.Item key="14"><Link to="/notice">공</Link></Menu.Item>
                    </SubMenu>
                </Menu>
            </Sider>
            // </Provider>
