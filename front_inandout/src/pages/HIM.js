    ...
    return (
        <Layout style={{ padding: '0 24px 24px' }}>
            ...
            <Descriptions title="의원 정보 관리" bordered>
                ...
                <Descriptions.Item label="의원 로고" span={3}>[데이터]</Descriptions.Item>
                <Descriptions.Item label="의원 연락처" span={3}>[데이터]</Descriptions.Item>
                <Descriptions.Item label="의원 주소" span={3}>[데이터]</Descriptions.Item>
                <Descriptions.Item label="대표자명" span={3}>[데이터]</Descriptions.Item>
            </Descriptions>
        </Layout>
    );
};
